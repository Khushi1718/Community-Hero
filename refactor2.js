...
// It looks like the original file has multiple "AI Monthly Impact Report" or maybe we need to be more precise
// Let's replace everything from {/* AI Report Tab */} up to {/* Admin Creation Modal */}
content = content.replace(/{\/\* AI Report Tab \*\/}.*?(?={\/\* Admin Creation Modal \*\/})/s, newTabsContent);
